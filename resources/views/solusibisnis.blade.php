...
.hero-content {
  color: #ffffff;
  max-width: 520px;
  margin: 0 auto;     /* pusatkan blok */
  text-align: center; /* pusatkan teks & button */
}
...
.category-tabs {
  display: flex;
  align-items: center;
  justify-content: center; /* isi tab ke tengah */
  gap: 12px;
  padding: 10px;
  background: #ffffff;
  border-radius: 50px;
  ...
  width: fit-content;
  margin: 0 auto; /* posisi tabs ke tengah halaman */
}
      ...
      <div class="tab-content-item active" id="retail-barang">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-4 mb-lg-0">
            ...
            <p class="text-muted">
              Bisnis retail adalah kegiatan menjual barang langsung kepada pelanggan akhir untuk kebutuhan pribadi, bukan untuk dijual kembali. Contohnya seperti minimarket, toko pakaian, toko elektronik, apotek, dan toko kecantikan.
            </p>
          </div>
